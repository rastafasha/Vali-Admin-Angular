...
const routes: Routes = [
  ...
  { path: 'financing', canActivate: [AuthGuard], component: ManageFinancingComponent },
  { path: 'financing/create', canActivate: [AuthGuard], component: FormFinancingComponent },
  { path: 'financing/edit/:id', canActivate: [AuthGuard], component: FormFinancingComponent },
