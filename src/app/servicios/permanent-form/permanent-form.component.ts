...
export class PermanentFormComponent implements OnInit {
  ...
  get buttonEs() { return this.permanentForm.get('buttonEs'); }
  get target() { return this.permanentForm.get('target'); }
  ...
  onSubmit() {
    ...
    formData.append('buttonEs', this.permanentForm.get('buttonEs').value);
    formData.append('target', this.permanentForm.get('target').value);
